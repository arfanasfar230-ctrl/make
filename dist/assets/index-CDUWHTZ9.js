...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ts(e,t,n){return new ma({name:`SphericalGaussianBlur`,defines:{SAMPLES:us,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Os(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Es(){return new ma({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Os(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ds(){return new ma({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Os(),fragmentShader:`
	...
	`}var ks=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Yi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
    ...
    `,this.highlightObject(e)}hideErgonomics(){this.ergoPanel.style.display=`none`,this.unhighlightAll()}highlightObject(e){this.unhighlightAll(),this.highlightedObject=e,e.object3D.traverse(e=>{e instanceof Zr&&(this.originalMaterials.set(e,e.material),e.material=new zr({color:15287648,transparent:!0,opacity:.3,wireframe:!1,depthWrite:!1}))})}unhighlightAll(){this.highlightedObject&&=(this.highlightedObject.object3D.traverse(e=>{if(e instanceof Zr){let t=this.originalMaterials.get(e);t&&(e.material=t,this.originalMaterials.delete(e))}}),null)}onResize(){let e=window.innerWidth,t=window.innerHeight;this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t)}animate=()=>{if(!this.isRunning)return;let e=Math.min(this.clock.getDelta(),.05),t;t=this.currentMode===`desktop`&&this.desktopControls?this.desktopControls.getInput():this.currentMode===`mobile`&&this.mobileControls?this.mobileControls.getInput():this.currentMode===`vr`&&this.vrSystem&&this.vrSystem.isInVR()?this.vrSystem.getInput():{moveForward:0,moveRight:0,lookX:0,lookY:0,interact:!1},this.player.update(t,e,(e,t)=>this.collision.resolvePosition(e,t,this.player.getHeight())),this.showReachIndicator&&this.updateReachIndicator();let n=this.ergonomics.findNearestObject(this.player.getPosition());if(n?(this.promptText.textContent=`${n.displayName} - Tekan [E] atau klik untuk menganalisis`,this.interactionPrompt.style.display=`block`,t.interact&&this.showErgonomics(n)):this.interactionPrompt.style.display=`none`,this.interaction.update(e)){let e=this.interaction.getHoverLabel?.()??`F / Klik untuk berinteraksi`;this.promptText.textContent=e,this.interactionPrompt.style.display=`block`,t.interact&&this.showInteractionPanel()}this.playerPosEl.textContent=`Pos: ${this.player.state.position.x.toFixed(2)}, ${this.player.state.position.y.toFixed(2)}, ${this.player.state.position.z.toFixed(2)}`,this.renderer.render(this.scene,this.camera)}};window.addEventListener(`DOMContentLoaded`,()=>{new Wd});